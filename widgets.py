...
class DateTimePicker(DateTimeInput):
    class Media:
        class JsFiles(object):
            def __iter__(self):
                yield 'efenua/js/moment.min.js'
                yield 'efenua/js/bootstrap-datetimepicker.min.js'
                ...
                if lang:
                    ...
                    if lang not in ('en', 'en-us'):
                        lang='fr'
                        yield 'efenua/js/locales/bootstrap-datetimepicker.%s.js' % (lang)

        js = JsFiles()
        css = {'all': ('efenua/css/bootstrap-datetimepicker.min.css',), }
