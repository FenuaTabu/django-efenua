...
class BSCTModelMixin(object):
    ...
    def get_absolute_url(self):
        ...
        """
        return reverse(
            '%s-detail' % self.bsct_view_prefix, kwargs={'pk': self.pk } 
        ) 
    ...
    def get_delete_url(self):
        ...
        """
        return reverse(
            '%s-delete' % self.bsct_view_prefix, kwargs={'pk': self.pk } 
        ) 
    ...
    def get_update_url(self):
        ...
        """
        return reverse(
            '%s-update' % self.bsct_view_prefix, kwargs={'pk': self.pk } 
        )
    ...
    def get_list_url(self):
        ...
        return reverse('%s-list' % self.bsct_view_prefix)
    ...
    def get_create_url(cls):
        ...
        """
        return reverse('%s-create' % cls.__name__.lower())
